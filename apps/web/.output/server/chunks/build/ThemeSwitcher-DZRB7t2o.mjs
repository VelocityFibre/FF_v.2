...
import { A } from './ThemeProvider-a-TiApaf.mjs';
import { M, s, i, c } from './zap-BiajdHZJ.mjs';
...
function y() {
  const { theme: s$1, setTheme: g } = A(), o = [{ value: "light", icon: M, label: "Light", description: "Clean Apple-inspired white theme" }, { value: "dark", icon: s, label: "Dark", description: "Elegant dark theme" }, { value: "vf", icon: i, label: "VelocityFibre", description: "VelocityFibre blue brand theme" }, { value: "fibreflow", icon: c, label: "FibreFlow", description: "Custom FibreFlow brand theme" }];
...
export { y };
//# sourceMappingURL=ThemeSwitcher-DZRB7t2o.mjs.map
